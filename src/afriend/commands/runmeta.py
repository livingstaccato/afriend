...
def _checkpoint_themes(meta: dict[str, Any]) -> tuple[list[ThemeProposal], bool]:
    """Retain the established checkpoint-validation import surface."""
    from .runmeta_checkpoint import _checkpoint_themes as validate_checkpoint_themes

    return validate_checkpoint_themes(meta)
